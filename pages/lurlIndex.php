...
<body class="mdui-appbar-with-toolbar mdui-theme-primary-<?=$lurlPrimaryTheme?> mdui-theme-accent-<?=$lurlAccentTheme?> mdui-theme-layout-auto mdui-loaded">
    <header class="mdui-appbar mdui-appbar-fixed">
        <div class="mdui-toolbar mdui-color-theme">
            ...
            <a href="./login" style="position: absolute; right: 5px; border-radius: 100%" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-purple" mdui-tooltip="{content: '登录', position: 'bottom'}"><i class="mdui-icon material-icons">account_circle</i></a>
        </div>
        ...
        <div class="mdui-card-content" style="margin-top: -35px">
            <div id="markdown-view" class="markdown-body editormd-html-preview">
                <form action="#" method="post">
                    ...
                    <p><input style="float: right;" class="mdui-btn mdui-color-theme-accent mdui-ripple" id="mode" type="submit" value="生成短网址"></p>
                    </br>
                    </form>
